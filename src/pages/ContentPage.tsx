                ...
                <div className="p-4">
                  ...
                  <div className="mt-4 grid grid-cols-2 gap-2">
                    ...
                    <button
                      type="button"
                      onClick={() => {
                        const tpl = saveFromPost(post.caption, `${post.status === 'published' ? 'Winning' : 'Saved'}: ${post.caption.slice(0, 28)}…`)
...
function ContentCalendar() {
  ...
  function freyaPlanWeek() {
    const extras: CalEvent[] = [
      { id: `ce${Date.now()}`, day: 17, title: 'GF croissant reel', color: 'mint' },
      ...
      <div className="relative flex flex-wrap items-center justify-between gap-3 border-b border-sky/15 px-4 py-3.5 md:px-5">
        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-full bg-gradient-to-r from-violet-500 to-sky-bright px-3.5 py-2 text-[12px] font-bold text-white shadow-md shadow-violet-300/40 hover:brightness-110"
          >
            <Sparkles className="h-3.5 w-3.5" />
            Freya, plan my week
          </button>
