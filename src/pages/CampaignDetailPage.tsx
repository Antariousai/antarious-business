...
export function CampaignDetailPage() {
  ...
  const cover = posts[0]?.image || BAKERY.berryTart
    ...
    <div className="space-y-5 px-8 py-6 pb-24">
      ...
      <section className="relative overflow-hidden rounded-2xl shadow-lg shadow-sky/15">
        <div className="absolute inset-0">
          ...
          <div className="absolute inset-0 bg-gradient-to-r from-navy-deep/95 via-navy-mid/85 to-violet-900/55" />
      ...
      <section className="overflow-hidden rounded-2xl border border-sky/15 bg-white shadow-sm">
        <div className="border-b border-sky/10 bg-gradient-to-r from-sky-soft/80 via-violet-50/50 to-amber-50/60 px-5 py-4 md:px-6">
          <h3 className="flex items-center gap-2 text-[16px] font-bold text-ink">
            <span className="flex h-8 w-8 items-center justify-center rounded-xl bg-gradient-to-br from-violet-500 to-sky-bright text-white shadow-sm">
          ...
          <div className="mx-4 mb-4 flex h-16 items-end gap-1 rounded-xl bg-slate-50/80 px-3 py-2 md:mx-5 md:gap-1.5">
            {engagement.map((e) => (
              <div key={e.label} className="flex min-w-0 flex-1 flex-col items-center gap-1">
                <div
                  className="w-full max-w-[28px] rounded-t-md bg-gradient-to-t from-violet-500 to-sky"
          ...
          <div className="grid gap-3 p-4 sm:grid-cols-2 md:p-5 lg:grid-cols-3">
            {(
              [
                ...
                ['Format', setup.format, 'from-violet-500 to-fuchsia-400'],
