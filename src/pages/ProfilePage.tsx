...
import { BAKERY, GOAL_OPTIONS } from '../data/mockData'
    ...
    <div className="relative px-6 py-6 pb-24 md:px-8">
      ...
      <section className="relative mx-auto max-w-2xl overflow-hidden rounded-[1.75rem] border border-sky/20 bg-white shadow-[0_20px_50px_-28px_rgba(14,165,233,0.45)]">
        ...
        <div className="relative h-44 w-full sm:h-52">
          <img src={BAKERY.bakeryCounter} alt="" className="h-full w-full object-cover" />
            ...
            <div className="mt-6">
              ...
              <div className="flex flex-wrap gap-2">
                {goalLabels.map((g) => (
                  <span
                    key={g}
                    className="rounded-full bg-gradient-to-r from-sky-soft to-violet-50 px-3.5 py-1.5 text-[12px] font-bold ring-1 ring-sky/20"
                    style={{ color: '#0284c7' }}
                  >
                    {g}
                  </span>
            ...
            <div className="flex flex-wrap gap-2">
              {channels.map((p) => {
                ...
                return (
                  <span
                    key={p}
                    className={`rounded-full px-3.5 py-1.5 text-[12px] font-bold ring-1 ${
                      connected
